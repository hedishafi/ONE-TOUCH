...
export function HowItWorks() {
  ...
  const FEATURES = [
    {
      icon: '🔒',
      title: t('howItWorks.feature1_title'),
      desc: t('howItWorks.feature1_desc'),
    },
    {
      icon: '📞',
      title: t('howItWorks.feature2_title'),
      desc: t('howItWorks.feature2_desc'),
    },
    {
      icon: '⭐',
      title: t('howItWorks.feature3_title'),
      desc: t('howItWorks.feature3_desc'),
    },
  ];
              ...
              <Box key={step.id} style={{ position: 'relative' }}>
                ...
                >
                  <Stack align="center" ta="center" gap="md">
                    ...
                    <div>
                      <Text size="sm" fw={700} c={step.color}
                        style={{ letterSpacing: '1px', textTransform: 'uppercase' }}>
                        {t('howItWorks.step_label', { number: step.number })}
                      </Text>
        ...
        <Box mx={{ base: 'md', sm: 'xl' }} mb={80}>
          <Container size="lg">
            <Box p={{ base: 40, sm: 60 }} style={{
              ...
              <Text fw={900} size="3xl" c="white" mb="sm"
                style={{ letterSpacing: '-0.5px', position: 'relative' }}>
                {t('howItWorks.cta_title')}
              </Text>
              <Text c="rgba(255,255,255,0.65)" mb="xl" size="md" style={{ position: 'relative' }}>
                {t('howItWorks.cta_sub')}
              </Text>
