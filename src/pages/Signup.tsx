          ...
          <Stack gap={36} className="su-page">
            ...
            >
              <RoleCard
                ...
                benefits={[
                  t('signup.client_benefit_1'),
                  t('signup.client_benefit_2'),
                  t('signup.client_benefit_3'),
                  t('signup.client_benefit_4'),
                ]}
              ...
              <RoleCard
                ...
                benefits={[
                  t('signup.provider_benefit_1'),
                  t('signup.provider_benefit_2'),
                  t('signup.provider_benefit_3'),
                  t('signup.provider_benefit_4'),
                ]}
            ...
            <Text ta="center" size="xs" c="#A0AEC0">
              ...
              <Text span fw={600} c={COLORS.tealBlue} style={{ cursor: 'pointer' }} onClick={() => navigate(ROUTES.termsOfService)}>{t('signup.terms')}</Text>
              {' '}{t('signup.agree_and')}{' '}
              <Text span fw={600} c={COLORS.tealBlue} style={{ cursor: 'pointer' }} onClick={() => navigate(ROUTES.privacyPolicy)}>{t('signup.privacy')}</Text>.
            </Text>
          </Stack>
        </Container>
      </Center>
